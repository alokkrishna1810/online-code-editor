...
export function EditorLayout() {
  ...
  const { activeFile, openFile, getFileContent, createFileFromTemplate } = fileSystem
  ...
  const canExecute = activeFile && ["python", "java", "cpp", "c", "javascript"].includes(currentLanguage)
    ...
    <div className="h-screen flex flex-col bg-background">
      ...
      <header className="border-b bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-card/30">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center space-x-2">
            <Button variant="ghost" size="sm" className="transition-theme hover:bg-accent/50">
        ...
        <ResizablePanelGroup direction="horizontal">
          ...
          <ResizablePanel defaultSize={sidebarCollapsed ? 50 : 40} minSize={25}>
            <ResizablePanelGroup direction="vertical">
              ...
              <ResizablePanel defaultSize={showExecutionPanel ? 60 : 70} minSize={30}>
              ...
              {/* Console Panel */}
              <ResizablePanel defaultSize={showExecutionPanel ? 40 : 30} minSize={20}>
                <OutputConsole
