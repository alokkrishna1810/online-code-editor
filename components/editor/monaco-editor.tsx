...
const getLanguageConfig = (lang: string) => {
  ...
  switch (lang) {
    case "python": return { ...baseConfig, tabSize: 4, rulers: [88] };
    case "java": return { ...baseConfig, tabSize: 4, rulers: [120] };
